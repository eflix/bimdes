...
$pdf = new FPDF('P','mm','A4');
        ...
        $pdf->setX(30);$pdf->Cell(60,6,'2.   Tempat / Tanggal Lahir',0,0);
        $pdf->Cell(20,6,': '.$dpByNik['dp_tempat_lahir'],0,1);
        $pdf->setX(30);$pdf->Cell(60,6,'3. Kewarganegaraan',0,0);
        $pdf->Cell(20,6,': '.$dpByNik['dp_kewarganegaraan'],0,1);
        $pdf->setX(30);$pdf->Cell(60,6,'4.   Agama',0,0);
        $pdf->Cell(20,6,': '.$dpByNik['dp_agama'],0,1);
        $pdf->setX(30);$pdf->Cell(60,6,'5.   Jenis Kelamin',0,0);
        $pdf->Cell(20,6,': '.$dpByNik['dp_gender'],0,1);
         $pdf->setX(30);$pdf->Cell(60,6,'6.   Pekerjaan',0,0);
        $pdf->Cell(20,6,': '.$dpByNik['dp_pekerjaan'],0,1);
        $pdf->setX(30);$pdf->Cell(60,6,'7.   Alamat',0,0);
        $pdf->Cell(20,6,': '.$dpByNik['dp_alamat'],0,1);

        $pdf->setX(30);$pdf->Cell(60,6,'8.   Surat Bukti Diri',0,1);
        $pdf->setX(30);$pdf->Cell(60,6,'      KTP',0,0);
        $pdf->Cell(20,6,': '.$dpByNik['dp_nik'],0,1);
        $pdf->setX(30);$pdf->Cell(60,6,'      No KK',0,0);
        $pdf->Cell(20,6,': '.$dpByNik['dp_no_kk'],0,1);
        
        $pdf->setX(30);$pdf->Cell(60,6,'9. Keperluan',0,0);
        $pdf->Cell(20,6,': '.$keperluan,0,1);
        $pdf->setX(30);$pdf->Cell(60,6,'10. Berlaku',0,0);
