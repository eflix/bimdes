...
$pdf = new FPDF('P','mm','A4');
        ...
        $pdf->Ln();
        $pdf->MultiCell(190,5,'         Orang tersebut di atas adalah benar-benar warga [Sebutan_Desa] [nama_des] yang memiliki usaha [form_usaha] di [alamat], [Sebutan_Desa] [nama_des], Kecamatan [nama_kec], [Sebutan_kabupaten] [nama_kab].',0,1);
        $pdf->Cell(190,7,'',0,1,'C');
