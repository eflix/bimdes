...
$pdf = new FPDF('P','mm','A4');
        ...
        $pdf->setX(30);$pdf->Cell(60,6,'12. Berlaku',0,0);
        $pdf->Cell(20,6,': '. date('d-m-y',strtotime($tglAwal)) . ' s/d '.date('d-m-y',strtotime($tglAkhir)) ,0,1);

        $pdf->Ln();
        $pdf->MultiCell(190,5,'         Orang tersebut adalah benar-benar warga Kelurahan '. $dpByNik['dp_kelurahan'] .' yang memiliki usaha '. $usaha,0,1);
