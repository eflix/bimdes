...
$pdf = new FPDF('P','mm','A4');
        ...
        $pdf->Cell(20,6,': '.$dpByNik['dp_tempat_lahir'].' / ' .$dpByNik['dp_tanggal_lahir'],0,1);
        ...
        $pdf->Ln();
        $pdf->MultiCell(190,5,'         Orang tersebut adalah benar-benar warga '.$dpByNik['dp_kelurahan'].' dengan data seperti di atas, dari keluarga kurang mampu pemegang Kartu Peserta Jamkesos No. '.$noJamkesos.' .',0,1);
        $pdf->Cell(190,7,'',0,1,'C');
