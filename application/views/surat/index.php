  <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <a href="<?= base_url('surat/tambah'); ?>" class="btn btn-primary btn-sm mb-3">Tambah Pengajuan Surat</a>
					            ...
					            <td>
					            	...
					            	<div class="dropdown">
									  ...
									  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
									    <li><a class="btn btn-warning btn-sm" href="<?= base_url('surat/ubah/') . $s['ps_id']; ?>">ubah</a></li>
