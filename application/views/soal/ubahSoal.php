...
<!-- Page Heading -->
   ...
   <form action="<?= base_url('soal/ubahSoal'); ?>" method="post">
   ...
   <input type="hidden" id="id_category" name="id_category" value="<?= $category; ?>">
    ...
    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <h7>File tipe : jpg/png</h7><br>
            <span><?= $soal['img_soal']; ?></span>
        </div>
        <div class="form-group">
    ...
    <a href="<?= base_url('soal/list/'.$category); ?>" class="btn btn-danger">Kembali</a>
      </form>
